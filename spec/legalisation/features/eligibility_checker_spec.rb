...
shared_examples_for "standard eligibility checker paths" do
...
describe "standard eligibility checker paths", :type => :feature do
  context "with js", :js => true do
    it_should_behave_like "standard eligibility checker paths"
  end
end
